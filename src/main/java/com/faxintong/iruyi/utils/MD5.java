...
public class MD5 {
    ...
    public static final MD5 newinstance()
    {
        if (md5 == null)
        {
            md5 = new MD5();
    ...
    {
        md5Init();
        md5Update(inbuf.getBytes(), inbuf.getBytes().length);
        md5Final();
        digestHexStr = "";
        for (int i = 0; i < 16; i++)
        {
    ...
    /**
     * F, G, H ,I 是4个基本的MD5函数，在原始的MD5的C实现中， 由于它们是简单的位运算，可能出于效率的考虑把它们实现成了宏，
